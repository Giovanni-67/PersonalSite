...
function SectionHeading({ id }) {
  return <Reveal className="section-heading"><span className="eyebrow">{headers[id]}</span><h2>{headers[id]}</h2></Reveal>
}
    ...
    <main>
      ...
      <section id="about" className="section section--about" aria-labelledby="about-title">
        <div className="container about-layout">
          <div><SectionHeading id="about" /><div className="about-copy" id="about-title">
            <Reveal><p>I’m Giovanni Peila, a Computer Science student at Cal Poly San Luis Obispo with interests in software engineering, artificial intelligence and machine learning, and systems.</p></Reveal>
            <Reveal delay={0.08}><p>I started programming and building websites at a young age—the original version of this portfolio was one of those early projects. Since then, my work has grown from small programming exercises into full-stack applications and systems-focused projects.</p></Reveal>
            <Reveal delay={0.16}><p>I’m especially interested in building reliable software, understanding how systems communicate, and exploring technology across finance, privacy, and security.</p></Reveal>
          </div></div>
          <Reveal className="progression-frame" delay={0.12}><div className="progression-glass" aria-label="Portfolio progression preview"><div className="progression-stage"><span className="mono-label">EARLY WEB WORK</span><span className="progression-year">13</span></div><div className="progression-line" aria-hidden="true"><span /></div><div className="progression-stage progression-stage--current"><span className="mono-label">CURRENT WORK</span><span className="progression-year">NOW</span></div></div><p className="progression-note">From early web work to systems-focused software.</p></Reveal>
        </div>
      </section>
